...
public class IngredientServiceImpl implements IngredientsService {
    ...
    @Override
    public List<IngredientCategoryResponseDto> findIngredientCategoryByRestaurantId(Long id) {
        Restaurant restaurant = restaurantService.findRestaurantById(id);
        List<IngredientCategory> categories = ingredientCategoryRepository.findByRestaurantId(restaurant.getId());
        return categories.stream()
                .map(category -> modelMapper.map(category, IngredientCategoryResponseDto.class))
                .toList();
    }
