...
import com.food.exception.common.*;
...
/**
 * Global exception handler for handling various types of exceptions and converting them into
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ExceptionResponse> handleRuntimeExceptions(RuntimeException exception) {
    ...
    return handleApiExceptions(
        new InternalServerErrorException(Objects.requireNonNull(getMessageSource())));
  }

  @ExceptionHandler(InternalAuthenticationServiceException.class)
  public ResponseEntity<ExceptionResponse> handleInternalAuthServiceExceptions(
